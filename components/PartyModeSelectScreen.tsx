  ...
  return (
    <div className="w-full max-w-md mx-auto p-8 bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-2xl border border-slate-700">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-cairo-black text-slate-100">وضع اللعب الجماعي</h1>
        <p className="text-slate-300 mt-2">أنشئ غرفة جديدة وادعُ أصدقاءك، أو انضم إلى غرفة موجودة.</p>
      </div>
