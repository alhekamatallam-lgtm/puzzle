...
export const PartyLobbyScreen: React.FC<PartyLobbyScreenProps> = ({ gameCode, isHost, onStart }) => {
  ...
  return (
    <div className="w-full max-w-lg mx-auto p-8 bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-2xl border border-slate-700 text-center">
        <SparklesIcon className="w-12 h-12 text-teal-400 mx-auto mb-4" />
        <h1 className="text-3xl font-cairo-black text-slate-100 mb-2">ردهة الانتظار</h1>
        ...
        <div className="mb-8">
            ...
            <div className="flex items-center justify-center gap-2">
                <p 
                    className="text-4xl font-bold tracking-widest text-orange-400 p-3 bg-slate-900 rounded-lg"
